#!/bin/bash
#@(#) Este script realiza o processo de instalação do PHP sem acesso root
# Felipe Bastos Nunes - 21/Oct/2020
# Leia o arquivo LICENSE para detalhes sobre cópia e uso deste pacote.

# Antes de executá-lo, precisamos garantir que o Lighttpd já foi instalado.
...
# Configurando o Lighttpd para trabalhar com o PHP
cd ~/lighttpd
